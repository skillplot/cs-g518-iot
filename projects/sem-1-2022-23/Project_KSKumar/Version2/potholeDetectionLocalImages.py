...
#reading test image
roadImg = cv2.imread("/home/pi/Images/pothole2.jpg") #image name
...
cv2.imwrite("finalDetection"+".jpg",roadImg) #result name

#Email Variables
SMTP_SERVER = 'smtp.gmail.com' #Email Server (don't change!)
SMTP_PORT = 587 #Server Port (don't change!)
GMAIL_USERNAME = 'iotproject@gmail.com' #change this to match your gmail account
GMAIL_PASSWORD = 'add your password here'  #change this to match your gmail password
...
sender = Emailer()
image = '/home/pi/pothole-detectionTest/finalDetection.jpg'
sendTo = ''
